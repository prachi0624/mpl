...
;Write a Terminate but Stay Resident (TSR) program for a key-    ;logger. 
;The key-presses during the stipulated time need to be displayed ;at the center of the screen.  
;OR Write a TSR to generate the pattern of the frequency tones by ;reading the Real Time       
