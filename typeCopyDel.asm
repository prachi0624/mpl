...
;Write X86 menus driven Assembly Language Program (ALP) to ;implement OS (DOS) commands TYPE, 
;COPY and DELETE using file operations. User is supposed to ;provide command line arguments in 
;all cases. 
